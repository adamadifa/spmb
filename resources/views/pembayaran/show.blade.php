            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-10">
                    <div class="mb-10 flex justify-between items-center">
                        <h2 class="text-3xl font-extrabold text-gray-900">Detail Pembayaran</h2>
                    ...
                    <div class="bg-white rounded-lg border border-gray-300 p-10 shadow-sm">
                        <!-- Header Invoice -->
                        <div class="flex justify-between items-start mb-10 pb-10 border-b border-gray-200">
                            <div>
                                <h3 class="text-2xl font-bold text-gray-900">INVOICE PEMBAYARAN</h3>
                                <p class="text-gray-600 mt-1">No. Register: {{ $pembayaran->no_register }}</p>
                            </div>
                                    ...
                                    <thead class="bg-gray-50">
                                        <tr>
                                            <th scope="col"
                                                ...
                                                Item</th>
                                            <th scope="col"
                                                class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Detail
                                            </th>
                                        </tr>
                                    </thead>
                        ...
                        @if ($pembayaran->status == 'pending' && Auth::user()->role === 'admin')
                            <div class="mt-10 pt-6 border-t border-gray-200">
                                <h4 class="text-lg font-semibold text-gray-900 mb-4">Aksi Admin</h4>
                ...
                @else
                    <div class="p-4 bg-gray-100 rounded-lg text-center">
                        ...
                        <a href="{{ $filePath }}" target="_blank"
                            class="mt-2 inline-flex items-center px-4 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700 transition-colors duration-200">
